# -*- coding: utf-8 -*-
"""
Created on Wed May 12 22:07:29 2021
...
model = new_Model.Net(num_list).to(device)
...
optimer = torch.optim.Adam(model.parameters(), lr=0.000001)
