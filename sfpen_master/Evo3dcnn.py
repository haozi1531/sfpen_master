# -*- coding: utf-8 -*-
"""
Created on Thu Jan 14 11:13:55 2021
    ...
    for i in range(15):
        for k in range(patchesLabels.shape[0]):
            if patchesLabels[k]==i:
                ...
                label_num+=1
    return cla_Data, cla_Labels.astype("int")
...
#           self.device = torch.device("cpu")
        def Evocnn_Fitness(self):
            ...
            #min_loss=10
            loss_list_x=[]
            data_path_indian = 'D://Hyperspectral_image//HSI//Indian_pines.mat'
            label_path_indian = 'D://Hyperspectral_image//HSI//Indian_pines_gt.mat'
